...
namespace OkulOtomasyonu.DbScript
{
	internal class DbScript
	{
		...
		//		/****** Object:  Login [##MS_PolicyEventProcessingLogin##]    Script Date: 10.10.2023 23:52:17 ******/
		//IF NOT EXISTS(SELECT* FROM sys.server_principals WHERE name = N'##MS_PolicyEventProcessingLogin##')
		//CREATE LOGIN[##MS_PolicyEventProcessingLogin##] WITH PASSWORD=N'bIryIEaDwSkzj0TiFlXXn/xE3ybIWaLfrpX1vS8F0XM=', DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON
		//GO
		//ALTER LOGIN[##MS_PolicyEventProcessingLogin##] DISABLE
		//GO
		///* For security reasons the login is created disabled and with a random password. */
		///****** Object:  Login [##MS_PolicyTsqlExecutionLogin##]    Script Date: 10.10.2023 23:52:17 ******/
		//IF NOT EXISTS(SELECT * FROM sys.server_principals WHERE name = N'##MS_PolicyTsqlExecutionLogin##')
		//CREATE LOGIN[##MS_PolicyTsqlExecutionLogin##] WITH PASSWORD=N'ilYNEQ/m32Qyo14mYMpytOL80OlV9KCCGCXWZCCjQX8=', DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON
		//GO
		//ALTER LOGIN[##MS_PolicyTsqlExecutionLogin##] DISABLE
		//GO
		///****** Object:  Login [NT AUTHORITY\SYSTEM]    Script Date: 10.10.2023 23:52:17 ******/
		//IF NOT EXISTS(SELECT * FROM sys.server_principals WHERE name = N'NT AUTHORITY\SYSTEM')
		//CREATE LOGIN[NT AUTHORITY\SYSTEM] FROM WINDOWS WITH DEFAULT_DATABASE =[master], DEFAULT_LANGUAGE =[us_english]
		//GO
		///****** Object:  Login [NT SERVICE\SQLSERVERAGENT]    Script Date: 10.10.2023 23:52:17 ******/
		//IF NOT EXISTS(SELECT * FROM sys.server_principals WHERE name = N'NT SERVICE\SQLSERVERAGENT')
		//CREATE LOGIN[NT SERVICE\SQLSERVERAGENT] FROM WINDOWS WITH DEFAULT_DATABASE =[master], DEFAULT_LANGUAGE =[us_english]
		//GO
		///****** Object:  Login [NT SERVICE\SQLTELEMETRY]    Script Date: 10.10.2023 23:52:17 ******/
		...
		//GO
		///****** Object:  Table [dbo].[__EFMigrationsHistory]    Script Date: 10.10.2023 23:52:17 ******/
		//SET ANSI_NULLS ON
		//GO
		...
		//GO
		///****** Object:  Table [dbo].[Dersler]    Script Date: 10.10.2023 23:52:17 ******/
		//SET ANSI_NULLS ON
		//GO
		//SET QUOTED_IDENTIFIER ON
		//GO
		...
		//GO
		///****** Object:  Table [dbo].[Kullanicilar]    Script Date: 10.10.2023 23:52:17 ******/
		//SET ANSI_NULLS ON
		//GO
		//SET QUOTED_IDENTIFIER ON
		//GO
		...
		//GO
		///****** Object:  Table [dbo].[KullaniciTipleri]    Script Date: 10.10.2023 23:52:17 ******/
		//SET ANSI_NULLS ON
		//GO
		//SET QUOTED_IDENTIFIER ON
		//GO
		...
		//GO
		///****** Object:  Table [dbo].[Müdürler]    Script Date: 10.10.2023 23:52:17 ******/
		//SET ANSI_NULLS ON
		//GO
		//SET QUOTED_IDENTIFIER ON
		//GO
		...
		//GO
		///****** Object:  Table [dbo].[Öğrenciler]    Script Date: 10.10.2023 23:52:17 ******/
		//SET ANSI_NULLS ON
		//GO
		//SET QUOTED_IDENTIFIER ON
		//GO
		...
		//GO
		///****** Object:  Table [dbo].[Öğretmenler]    Script Date: 10.10.2023 23:52:17 ******/
		//SET ANSI_NULLS ON
		//GO
		//SET QUOTED_IDENTIFIER ON
		//GO
		...
		//GO
		///****** Object:  Table [dbo].[Sınavlar]    Script Date: 10.10.2023 23:52:17 ******/
		//SET ANSI_NULLS ON
		//GO
		//SET QUOTED_IDENTIFIER ON
		//GO
		...
		//GO
		///****** Object:  Table [dbo].[SınavSonuçları]    Script Date: 10.10.2023 23:52:17 ******/
		//SET ANSI_NULLS ON
		//GO
		//SET QUOTED_IDENTIFIER ON
		//GO
		...
		//GO
		///****** Object:  Table [dbo].[Sınıflar]    Script Date: 10.10.2023 23:52:17 ******/
		//SET ANSI_NULLS ON
		//GO
		//SET QUOTED_IDENTIFIER ON
		//GO
		...
		//GO
		///****** Object:  Table [dbo].[Veliler]    Script Date: 10.10.2023 23:52:17 ******/
		//SET ANSI_NULLS ON
		//GO
		//SET QUOTED_IDENTIFIER ON
		//GO
		...
		//		([kullaniciID], [tipID], [kullaniciAdi], [sifre], [eposta], [telefon]) VALUES(1, 1, N'1', N'1', NULL, NULL)
		//GO
		//INSERT[dbo].[Kullanicilar]
		//		([kullaniciID], [tipID], [kullaniciAdi], [sifre], [eposta], [telefon]) VALUES(2, 2, N'2', N'2', NULL, NULL)
		//GO
		//INSERT[dbo].[Kullanicilar]
		//		([kullaniciID], [tipID], [kullaniciAdi], [sifre], [eposta], [telefon]) VALUES(3, 3, N'3', N'3', NULL, NULL)
		//GO
		//SET IDENTITY_INSERT[dbo].[Kullanicilar]
		//		OFF
		//GO
		...
		//GO
		//IF NOT EXISTS(SELECT* FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Öğrenciler_Veliler]') AND parent_object_id = OBJECT_ID(N'[dbo].[Öğrenciler]'))
		//ALTER TABLE[dbo].[Öğrenciler] WITH CHECK ADD CONSTRAINT[FK_Öğrenciler_Veliler] FOREIGN KEY([veliID])
		//REFERENCES[dbo].[Veliler]
		//		([veliID])
		//GO
		//IF EXISTS(SELECT* FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Öğrenciler_Veliler]') AND parent_object_id = OBJECT_ID(N'[dbo].[Öğrenciler]'))
		//ALTER TABLE[dbo].[Öğrenciler]

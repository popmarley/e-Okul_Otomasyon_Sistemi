...
//		/****** Object:  Login [##MS_PolicyEventProcessingLogin##]    Script Date: 13.10.2023 00:00:34 ******/
//IF NOT EXISTS(SELECT* FROM sys.server_principals WHERE name = N'##MS_PolicyEventProcessingLogin##')
//CREATE LOGIN[##MS_PolicyEventProcessingLogin##] WITH PASSWORD=N'rCGwphMbPkWAnz481rmX5DZBUknu2HPHTk6jBcMmQEQ=', DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON
//GO
//ALTER LOGIN[##MS_PolicyEventProcessingLogin##] DISABLE
//GO
///* For security reasons the login is created disabled and with a random password. */
///****** Object:  Login [##MS_PolicyTsqlExecutionLogin##]    Script Date: 13.10.2023 00:00:34 ******/
//IF NOT EXISTS(SELECT * FROM sys.server_principals WHERE name = N'##MS_PolicyTsqlExecutionLogin##')
//CREATE LOGIN[##MS_PolicyTsqlExecutionLogin##] WITH PASSWORD=N'8E/l7emD9LmoAjwD6OVefe2o6Z0auqg6ViDtsL+AINo=', DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON
//GO
//ALTER LOGIN[##MS_PolicyTsqlExecutionLogin##] DISABLE
//GO
///****** Object:  Login [NT AUTHORITY\SYSTEM]    Script Date: 13.10.2023 00:00:34 ******/
//IF NOT EXISTS(SELECT * FROM sys.server_principals WHERE name = N'NT AUTHORITY\SYSTEM')
//CREATE LOGIN[NT AUTHORITY\SYSTEM] FROM WINDOWS WITH DEFAULT_DATABASE =[master], DEFAULT_LANGUAGE =[us_english]
//GO
///****** Object:  Login [NT SERVICE\SQLSERVERAGENT]    Script Date: 13.10.2023 00:00:34 ******/
//IF NOT EXISTS(SELECT * FROM sys.server_principals WHERE name = N'NT SERVICE\SQLSERVERAGENT')
//CREATE LOGIN[NT SERVICE\SQLSERVERAGENT] FROM WINDOWS WITH DEFAULT_DATABASE =[master], DEFAULT_LANGUAGE =[us_english]
//GO
///****** Object:  Login [NT SERVICE\SQLTELEMETRY]    Script Date: 13.10.2023 00:00:34 ******/
...
//GO
///****** Object:  Table [dbo].[__EFMigrationsHistory]    Script Date: 13.10.2023 00:00:34 ******/
//SET ANSI_NULLS ON
//GO
...
//GO
///****** Object:  Table [dbo].[Dersler]    Script Date: 13.10.2023 00:00:34 ******/
//SET ANSI_NULLS ON
//GO
//SET QUOTED_IDENTIFIER ON
//GO
...
//GO
///****** Object:  Table [dbo].[Kullanicilar]    Script Date: 13.10.2023 00:00:34 ******/
//SET ANSI_NULLS ON
//GO
//SET QUOTED_IDENTIFIER ON
//GO
...
//GO
///****** Object:  Table [dbo].[KullaniciTipleri]    Script Date: 13.10.2023 00:00:34 ******/
//SET ANSI_NULLS ON
//GO
//SET QUOTED_IDENTIFIER ON
//GO
...
//GO
///****** Object:  Table [dbo].[Mudurler]    Script Date: 13.10.2023 00:00:34 ******/
//SET ANSI_NULLS ON
//GO
//SET QUOTED_IDENTIFIER ON
//GO
...
//GO
///****** Object:  Table [dbo].[OgrenciDersleri]    Script Date: 13.10.2023 00:00:34 ******/
//SET ANSI_NULLS ON
//GO
//SET QUOTED_IDENTIFIER ON
//GO
...
//GO
///****** Object:  Table [dbo].[Ogrenciler]    Script Date: 13.10.2023 00:00:34 ******/
//SET ANSI_NULLS ON
//GO
//SET QUOTED_IDENTIFIER ON
//GO
...
//GO
///****** Object:  Table [dbo].[Ogretmenler]    Script Date: 13.10.2023 00:00:34 ******/
//SET ANSI_NULLS ON
//GO
//SET QUOTED_IDENTIFIER ON
//GO
...
//GO
///****** Object:  Table [dbo].[Sinavlar]    Script Date: 13.10.2023 00:00:34 ******/
//SET ANSI_NULLS ON
//GO
//SET QUOTED_IDENTIFIER ON
//GO
...
//GO
///****** Object:  Table [dbo].[SinavSonuclari]    Script Date: 13.10.2023 00:00:34 ******/
//SET ANSI_NULLS ON
//GO
//SET QUOTED_IDENTIFIER ON
//GO
...
//GO
///****** Object:  Table [dbo].[Siniflar]    Script Date: 13.10.2023 00:00:34 ******/
//SET ANSI_NULLS ON
//GO
//SET QUOTED_IDENTIFIER ON
//GO
...
//GO
///****** Object:  Table [dbo].[Veliler]    Script Date: 13.10.2023 00:00:34 ******/
//SET ANSI_NULLS ON
//GO
//SET QUOTED_IDENTIFIER ON
//GO
...
//GO
//IF NOT EXISTS(SELECT* FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Öğretmenler_Dersler]') AND parent_object_id = OBJECT_ID(N'[dbo].[Ogretmenler]'))
//ALTER TABLE[dbo].[Ogretmenler] WITH CHECK ADD CONSTRAINT[FK_Öğretmenler_Dersler] FOREIGN KEY([dersID])
//REFERENCES[dbo].[Dersler]
//		([dersID])
//GO
//IF EXISTS(SELECT* FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Öğretmenler_Dersler]') AND parent_object_id = OBJECT_ID(N'[dbo].[Ogretmenler]'))
//ALTER TABLE[dbo].[Ogretmenler]
//		CHECK CONSTRAINT[FK_Öğretmenler_Dersler]
//GO
